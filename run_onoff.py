...
from src.ingest import get_game_ids_for_date, get_boxscore_player_df
...
def main():
    ...
    out_path = DATA_DIR / "adjusted_onoff.csv"
    ...
    for d in daterange(start, end):
        ...
        for game_id in game_ids:
            ...
            try:
                ...
                if player_df.empty:
                    print("SKIP (empty player df)", game_id)
                    continue

                player_state = ensure_players_exist(player_state, player_df)

                onoff_df = compute_adjusted_onoff_for_game(
                    game_id=game_id,
