  ...
  <div class="wrap">
    <section class="hero">
      ...
      <div class="nav" style="margin-top:6px">
        ...
        <a href="rapm.html">Regular Season</a>
        <a href="rapm-playoffs.html" style="background:rgba(245,132,38,.18);border-color:rgba(245,132,38,.6);font-weight:700;">Playoffs</a>
      </div>
    </section>
