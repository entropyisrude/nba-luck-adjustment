...
def build_eoin_seasons() -> list[dict]:
    ...
    for _, r in agg.iterrows():
        ...
        records.append({
            ...
            "tov":   per36(r["tov"], m),
            "fta":   per36(r["fta"], m),
            "fg2a":  per36(r["fga"] - r["fg3a"], m),
            "fg3a":  per36(r["fg3a"], m),
            # shooting pct
            "fg2p":  pct(r["fgm"] - r["fg3m"], r["fga"] - r["fg3a"]) if (r["fga"] - r["fg3a"]) > 0 else None,
...
def build_db_seasons(pbp_onoff: dict) -> list[dict]:
    ...
    for _, r in df.iterrows():
        ...
        records.append({
            ...
            "tov":    per36(r["tov_s"], m),
            "fta":    per36(r["fta_s"], m),
            "fg2a":   per36(r["fga_s"] - r["fg3a_s"], m),
            "fg3a":   per36(r["fg3a_s"], m),
            "fg2p":   pct(r["fgm_s"] - r["fg3m_s"], r["fga_s"] - r["fg3a_s"]) if (r["fga_s"] - r["fg3a_s"]) > 0 else None,
